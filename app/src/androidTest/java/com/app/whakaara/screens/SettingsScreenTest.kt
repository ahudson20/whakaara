...
class SettingsScreenTest {
    ...
    @Test
    @Ignore("Flaky")
    fun shouldDisplayCorrectDataDefaultStateAlarmSettings(): Unit = with(composeTestRule) {
        // Given
    ...
    @Test
    @Ignore("Flaky")
    fun shouldDisplayCorrectDataDefaultStateTimerSettings(): Unit = with(composeTestRule) {
        // Given
        val state = PreferencesState()
