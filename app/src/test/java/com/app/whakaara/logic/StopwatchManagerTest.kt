...
class StopwatchManagerTest {
    ...
    @Test
    fun `lap stopwatch not empty list`() =
        runTest {
            // Given
            val current = 123123L
    ...
    @Test
    fun `recreate stopwatch paused from receiver - manager state not empty`() =
        runTest {
            // Given
    ...
    @Test
    fun `recreate stopwatch paused from receiver - manager state empty`() =
        runTest {
            // Given
            stopwatchManagerWrapper.stopwatchState.value = StopwatchState()
            val stateFromPreferences = StopwatchState(
