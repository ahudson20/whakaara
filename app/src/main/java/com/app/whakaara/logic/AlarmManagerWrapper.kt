...
class AlarmManagerWrapper
    ...
    constructor(
        ...
        fun setUpcomingAlarm(
            ...
            val triggerTimeMinusTenMinutes =
                (triggerTime.clone() as Calendar).apply {
                    add(Calendar.MINUTE, -upcomingAlarmNotificationTime)
                }

            val upcomingAlarmIntent =
                Intent(app, UpcomingAlarmReceiver::class.java).apply {
                    action = alarmId
        ...
        fun cancelUpcomingAlarm(
            ...
            val upcomingAlarmPendingIntent =
                PendingIntentUtils.getBroadcast(
                    context = app,
                    id = INTENT_REQUEST_CODE,
                    intent = upcomingAlarmIntent,
